const app = `export default function Home() {
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-indigo-500 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { title: "Secure by Design", desc: "Built with security in mind from day one.", icon: "🔒" },
              { title: "Scalable Architecture", desc: "Grow your user base without worry.", icon: "📈" }
            ].map((item, index) => (
      ...
      <footer className="py-12 border-t border-slate-800 text-center">
        ...
        <p className="text-slate-500 text-sm">© 2026 Product Name. All rights reserved.</p>
      </footer>
    </div>
  )
}

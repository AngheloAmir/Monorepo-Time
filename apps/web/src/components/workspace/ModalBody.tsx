export default function ModalBody( { children }: { children: React.ReactNode }) {
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div onClick={(e) => e.stopPropagation()} className="relative w-full md:w-[620px] h-[70vh] flex flex-col rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/20 animate-fade-in-up">

    ...
    return (
        <div className={`h-full w-full flex items-center justify-center p-4 ${isVisible ? 'flex' : 'hidden'}`}>
            <div className="w-full h-full flex flex-col items-center justify-center text-center relative overflow-hidden">
                ...
                <div className="relative w-72 h-40 bg-gray-900/80 rounded-xl border border-white/10 mb-8 overflow-hidden flex shadow-2xl select-none scale-125 transform transition-transform hover:scale-105 duration-500">
                    <style>{`
                        @keyframes drag-move {
                ...
                <h2 className="text-3xl font-bold text-white mb-2">Opencode Ready</h2>
                <div className="max-w-2xl">
                    <p className="text-neutral-300 mb-4 text-lg leading-relaxed">
                        OpenCode is an advanced AI coding assistant that helps you write code, debug errors, and understand your project structure directly from the terminal.
                    </p>
                ...
                <button
                    onClick={onStart}
                    className="group relative inline-flex items-center justify-center px-12 py-4 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 focus:ring-offset-neutral-900 text-lg transform hover:-translate-y-1"
                >
